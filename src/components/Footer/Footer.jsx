              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3">
                ...
                <div>
                  ...
                  <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">
                    <a href="mailto:shreyashdas74@gmail.com">
                      shreyashdas74@gmail.com
                    </a>
                  </span>
                  <span className="block space-x-2 mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">
                    <a
                      href="https://www.linkedin.com/in/shreyash-das/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                    ...
                    <a
                      href="https://github.com/shreyash-Das234"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                    ...
                    <a
                      href="mailto:shreyashdas74@gmail.com"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                    ...
                    <a
                      href="https://www.youtube.com/channel/UC_dAXp2RYi9JDzg2k41vC6w"
                      className="inline"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
